 ...
 */
public class MoteTypeTaskVO {

    public TaskItemVO productItemVO1;
    public TaskItemVO productItemVO2;

    public ModelInfo.DataEntity moteItemVO1;
    public ModelInfo.DataEntity moteItemVO2;
