...
public class CareActivity extends Activity {
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            //设置adapter
            MasonryAdapter adapter = new MasonryAdapter(allModel, CareActivity.this, new MasonryAdapter.ChangeText() {
                @Override
    ...
    public void init() {
        ...
        find.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CareActivity.this, ChooseActivity.class));
            }
        });
...
//                handler.sendEmptyMessage(1);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("token","8B475A67EF194C842C1F7A828F07355B4B7C77A1D16A6FC7D1D797C872669E63D19BD0981CE110AAE8B9F1BA405E8557");
                return params;
            }
        };
        queue.add(request);
