...
//        qqSsoHandler.setTitle("来自“全民模特”的分享");
        ...
        //设置分享图片
        qqShareContent.setShareImage(new UMImage(SettingPersonInfoActivity.this, R.drawable.icon));
        //设置点击分享内容的跳转链接
        ...
        //设置分享图片
        qzone.setShareImage(new UMImage(SettingPersonInfoActivity.this, R.drawable.icon));
