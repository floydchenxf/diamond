package com.floyd.diamond.ui.pageindicator;//package com.alibaba.mobileim.fundamental.widget.pageindicator;
//
...
////            	WxLog.d("test", "onPageScrolled removeCallbacks");
////                removeCallbacks(mFadeRunnable);
////                mPaint.setAlpha(0xFF);
////            } else if (mScrollState != ViewPager.SCROLL_STATE_DRAGGING) {
////            	WxLog.d("test", "onPageScrolled postDelayed");
////                postDelayed(mFadeRunnable, mFadeDelay);
////            }
////        }
//        invalidate();
...
//            invalidate();
//        }
//        WxLog.d("test", "onPageSelected:"+position);
////        mFadeRunnable.run();
//
//        if (mListener != null) {
